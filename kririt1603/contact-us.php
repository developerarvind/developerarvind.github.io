...
$msg=$_POST['msg'];
        ...
        $message="<p> Dear Sir</p>
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%' >
                  ...
                  <tr><td>Organization&nbsp;</td><td> : </td><td>".$organization."</td></tr>
                  <tr><td>Country&nbsp;</td><td> : </td><td>".$country."</td></tr>
                  <tr><td>State&nbsp;</td><td> : </td><td>".$state."</td></tr>
                  <tr><td>How you wish to connect&nbsp;</td><td> : </td><td>".$radio."</td></tr>
 ...
 send_mail($to, $subject, $message,$mobile,$email,$name);
        ...
        $message1= "<p> Dear ".$name."</p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp; Thank You for your interest. Our executive will get in touch with you shortly. </p>
